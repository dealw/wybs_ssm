...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/travller/update.do"
				method="post">
				<!-- 正文区域 -->
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
									name="sex">
								<c:choose>
									<c:when test="${traveller.sex=='男'}">
									<option value="男" selected="selected">男</option>
										<option value="女">女</option>
									</c:when>
									<c:when test="${traveller.sex=='女'}">
						...
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
								...
								<c:choose>
									<c:when test="${traveller.credentialsType==0}">
										<option value="0" selected="selected">身份证</option>
										<option value="1">护照</option>
										<option value="3">军官证</option>
									</c:when>
									<c:when test="${traveller.credentialsType==1}">
										<option value="0" >身份证</option>
										<option value="1" selected="selected">护照</option>
										<option value="3">军官证</option>
									</c:when>
									<c:when test="${traveller.credentialsType==2}">
										<option value="0" >身份证</option>
										<option value="1">护照</option>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="credentialsNum" id="credentialsNum"
								   placeholder="请输入证件号码">
						</div>
	...
	<script>
		...
		$(function (){
			$("#name").val("${traveller.name}");
			$("#phoneNum").val("${traveller.phoneNum}");
			$("#credentialsNum").val("${traveller.credentialsNum}");
		});
		// 设置激活菜单
