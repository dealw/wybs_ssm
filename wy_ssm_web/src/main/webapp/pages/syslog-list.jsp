...
<body class="hold-transition skin-blue sidebar-mini">
				...
				<div class="box-footer">
					<div class="pull-left">
						<div class="form-group form-inline">
							...
							</select>  条 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button onclick="jump()">跳转到第</button><input type="number" style="width: 80px" id="pagenum">页
						</div>
					</div>
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							...
							<%--展示页码--%>
							<c:if test="${pageInfo.pageNum+12>pageInfo.pages}">
							<c:forEach begin="${pageInfo.pageNum}" end="${pageInfo.pages}" var="cur">
								<li><a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${cur}&size=${pageInfo.pageSize}">${cur}</a></li>
							</c:forEach>
							</c:if>
							<c:if test="${pageInfo.pageNum+12<=pageInfo.pages}">
								<c:forEach begin="${pageInfo.pageNum}" end="${pageInfo.pageNum+12}" var="cur">
									<li><a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${cur}&size=${pageInfo.pageSize}">${cur}</a></li>
								</c:forEach>
							</c:if>
	...
	<script>
		...
		//页数跳转
		function jump(){
			location.href="${pageContext.request.contextPath}/sysLog/findAll.do?page="+$("#pagenum").val()+"&size="
					+ ${pageInfo.size};
		}
		// 设置激活菜单
