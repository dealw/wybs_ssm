...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/register/update.do"
				method="post">
				<!-- 正文区域 -->
				<section class="content"> <!--产品信息-->
				<input type="hidden" name="password" value="${regist.password}">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="realName"
								  readonly="readonly"   value="${regist.realName}">
						</div>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="phoneNum" id="phone"
								   placeholder="请输入联系电话">
						</div>
						</div>
					</div>
	...
	<script>
		...
		$(function (){
			$("#username").val("${regist.username}");
			$("#email").val("${regist.email}");
			$("#phone").val("${regist.phoneNum}");
		});
		// 设置激活菜单
