...
<security:authorize access="hasAnyRole('ADMINISTRATOR','MANAGER','SALESPERSON','EXECUTIVE')">
		<span class="logo-lg"><b>企业权限管理</b></span>
</security:authorize>
		<security:authorize access="hasRole('USER')">
			<span class="logo-lg"><b>旅游网</b></span>
		</security:authorize>
				...
				<li class="dropdown user user-menu"><a href="#"
					...
					<ul class="dropdown-menu">
						...
						<li class="user-footer">
							<div class="pull-left">
								<a href="${pageContext.request.contextPath}/pages/repass.jsp" class="btn btn-default btn-flat">修改密码</a>
							</div>
