		...
		<ul class="sidebar-menu">
			...
			<security:authorize access="hasRole('USER')">
				<li id="system-setting"><a
						href="${pageContext.request.contextPath}/product/findAll.do?page=1&size=4"> <i
						class="fa fa-circle-o"></i> 选购产品
				</a></li>
				<li id="system-setting"><a
						href="${pageContext.request.contextPath}/orders/findAllByMemberId.do?page=1&size=4&id=${sessionScope.userId}"> <i
						class="fa fa-circle-o"></i> 我的订购
				</a></li>
				<li id="system-setting"><a
						href="${pageContext.request.contextPath}/user/findByUserId.do?id=${sessionScope.userId}"> <i
...
<%--			只有工作人员才能访问的模块--%>
			...
			<li class="treeview"><a href="#"> <i class="fa fa-cube"></i>
				...
				<ul class="treeview-menu">
					...
					<security:authorize access="hasAnyRole('ADMINISTRATOR','MANAGER')">
						<li id="system-setting"><a
								href="${pageContext.request.contextPath}/travller/findAll.do?page=1&size=4"> <i
